...
namespace behaviac
{
	...
	{
		// Token: 0x0601A5F5 RID: 108021 RVA: 0x0082AF6F File Offset: 0x0082936F
		public CAgentStaticMethod(CAgentStaticMethod<T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>.FunctionPointer f)
		{
			this._fp = f;
		}

		// Token: 0x0601A5F6 RID: 108022 RVA: 0x0082AF80 File Offset: 0x00829380
		public CAgentStaticMethod(CAgentStaticMethod<T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> rhs) : base(rhs)
		{
			this._fp = rhs._fp;
			this._p1 = rhs._p1;
			this._p2 = rhs._p2;
		...
		// Token: 0x0601A5F7 RID: 108023 RVA: 0x0082B018 File Offset: 0x00829418
		public override IMethod Clone()
		{
			return new CAgentStaticMethod<T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(this);
		}

		// Token: 0x0601A5F8 RID: 108024 RVA: 0x0082B020 File Offset: 0x00829420
		...
		// Token: 0x0601A5F9 RID: 108025 RVA: 0x0082B0C4 File Offset: 0x008294C4
		...
		// Token: 0x0601A5FA RID: 108026 RVA: 0x0082B194 File Offset: 0x00829594
		...
		private CAgentStaticMethod<T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>.FunctionPointer _fp;
		...
		// (Invoke) Token: 0x0601A5FC RID: 108028
